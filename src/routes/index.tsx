...
export default function Index() {
    ...
    return (
        <article>
            ...
            <p>Jag är en handarbetande frontendutvecklare och kattägare i Arvika. Från mig kan du kan förvänta dig:</p>
            <ul>
            ...
            <p>Jag började egentligen programmera i tonåren; omkring 2000-2010 när var och varannan hade blogg, inklusive mig. Du kunde välja bland olika teman och du kunde även hitta egen gjorda teman av andra användare. Coolt tyckte jag. Men det tyckte även andra.</p>
            <p>Ganska snart upptäckte jag att den där obegripliga texten (HTML & CSS), som temana bestod av, faktiskt gick att justera själv utan att bloggen "brakade ihop". För det mesta så testade jag mig fram men ibland stötte jag på blogginlägg om hur man gör. Detta var en rolig period och jag skaffade ett mig nytt tema minst en gång i veckan och när jag inte hade ett nytt tema så gjorde jag massor av små justeringar!</p>
